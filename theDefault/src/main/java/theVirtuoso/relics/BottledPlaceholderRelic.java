...
import theVirtuoso.patches.relics.BottledPlaceholderField;
import theVirtuoso.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theVirtuoso.DefaultMod.makeRelicOutlinePath;
import static theVirtuoso.DefaultMod.makeRelicPath;
